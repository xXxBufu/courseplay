...
--[[ Using example:
-- create Grid
local hjsGrid = courseplay.algo.helpers.Grid:new(tileSize, course.waypoints, 'cx', 'cz');
...
algo.Pathfinder = {}
algo.Pathfinder.__index = algo.Pathfinder

function algo.Pathfinder:new(grid, finderName, walkable)
	local newPathfinder = {}
	setmetatable(newPathfinder, algo.Pathfinder)
...
function algo.Pathfinder:setGrid(grid)
...
function algo.Pathfinder:getGrid()
	return self.grid
end

function algo.Pathfinder:setWalkable(walkable)
...
function algo.Pathfinder:getWalkable()
	return self.walkable
end

function algo.Pathfinder:setFinder(finderName)
...
function algo.Pathfinder:getFinder()
	return self.finder
end

function algo.Pathfinder:getFinders()
	return collect_keys(Finders)
end

function algo.Pathfinder:setHeuristic(heuristic)
...
function algo.Pathfinder:getHeuristic()
	return self.heuristic
end

function algo.Pathfinder:getHeuristics()
	return collect_keys(helpers.Heuristics)
end

function algo.Pathfinder:setMode(mode)
	assert(searchModes[mode],'Invalid mode')
	self.allowDiagonal = (mode == 'DIAGONAL')
	return self
end

function algo.Pathfinder:getMode()
	return (self.allowDiagonal and 'DIAGONAL' or 'ORTHOGONAL')
end

function algo.Pathfinder:getModes()
	return collect_keys(searchModes)
end

function algo.Pathfinder:version()
