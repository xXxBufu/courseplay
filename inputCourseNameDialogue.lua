...
function inputCourseNameDialogue:onSaveClick()
	...
	elseif vehicle.cp.saveWhat == 'folder' then
		...
		local folder = { id = folderID, uid = 'f'..folderID, type = 'folder', name = self.textInputElement.text, nameClean = courseplay:normalizeUTF8(self.textInputElement.text), parent = 0 }
